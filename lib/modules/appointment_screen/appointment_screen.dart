...
class AppointmentScreen extends StatefulWidget {
  final int id ;
  const AppointmentScreen( {Key? key, required this.id}) : super(key: key);
...
class _AppointmentScreenState extends State<AppointmentScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: buildNotConnectedScreen(screen: buildAppointmentScreen(context)) ,
    );
  }

  Widget buildAppointmentScreen(context){
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: cubit.appointmentModel?.data == null
                    ...
                    physics: const BouncingScrollPhysics(),
                    itemBuilder: (context, index) => dayItem(index,context, cubit.appointmentModel!.data![index]),
        ...
        child: Padding(
          ...
          child: SizedBox(
            ...
            child: Column(
              ...
              children: [
                Text(
                  DateFormat('dd').format(DateTime.parse(appointmentData.dateCenter.toString())),
                  style: TextStyle(
                ...
                Text(
                  DateFormat('MMM').format(DateTime.parse(appointmentData.dateCenter.toString())),
                  style: TextStyle(
                    color: checked ? Colors.white : Colors.black,
                    fontSize: 16,
                    fontWeight: FontWeight.bold,
